            ...
            <div className="icons">
              ...
              <div className="navProfile">
                <div className="profileWrapper" id="navProfile">
                  <img src="/images/myprofile.jpeg" alt="profile_image" className="profileImg" />
                </div>
              </div>
            </div>
                ...
                <li className="story">
                  <div className="storyWrapper">
                    <div className="profileWrapper large">
                      <img src="/images/wecode.png" alt="story_image" className="profileImg large" />
                    </div>
              ...
              <article className="content">
                <header className="contentHeader content-box">
                  <div className="writerInfo">
                    <div className="profileWrapper medium">
                      <img src="/images/wecode.png" alt="story_image" className="profileImg medium" />
                    </div>
                ...
                <div className="mainContents">
                  ...
                  <img src="/images/mainpage.jpg" alt="content_image" className="contentImg" />
                </div>
          ...
          <aside className="sideBar">
            <div className="profileChange">
              <div className="myProfile">
                <img src="/images/myprofile.jpeg" alt="story_image" className="profileImg large" />
                ...
                <div className="suggestedProfile">
                  <div className="otherProfile">
                    ...
                    <div className="suggestProfileDetails">
                      ...
                      <span className="profileDesc">Followed by picnic606 + 1 more</span>
                    </div>
                  </div>
                  <button className="Btn" type="button">
                    Follow
            ...
            <div className="serviceDetails">
              ...
              <div className="serviceLinks copyright">© 2021 INSTAGRAM FROM FACEBOOK</div>
            </div>
          </aside>
        </div>
      </>
